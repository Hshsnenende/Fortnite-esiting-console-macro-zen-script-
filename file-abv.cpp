combo EDIT_SELECT_CONFIRM_LOOP {
    ...
    int PS4_RIGHT = PS4_RIGHT; // Define your PS4_RIGHT (Right Arrow)

    // Initialize a flag to track script activation
    int ScriptActive;
    ...
    do {
        ...
        if (event_press(PS4_RIGHT)) {
            ScriptActive = !ScriptActive; // Toggle script activation
        }

        // Perform actions while the script is active
        if (ScriptActive) {
            // Edit
